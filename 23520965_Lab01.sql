...
SELECT (SELECT TenKyNang FROM KyNang WHERE KyNang.MaKyNang=ChuyenGia_KyNang.MaKyNang) AS TenKyNang, CapDo FROM CHuyenGia_KyNang;
...
SELECT TenDuAn, TrangThai FROM DuAn WHERE TrangThai NOT LIKE 'Hoàn thành';
